...
export const PLANS: Record<PlanTier, PlanDetails> = {
  FREE: {
    ...
    description: 'Perfect for exploring African-centered learning sets and testing study generation tools.',
    features: [
      '400 once-off credits on sign up',
